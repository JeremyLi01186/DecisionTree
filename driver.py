...
header = ['native', 'C_instructor', 'Course', 'semester', 'C_size', 'Class']
df = pd.read_csv('UCI_TA.csv', header=None, names=['native', 'C_instructor', 'Course', 'semester', 'C_size', 'Class'])
...
t_pruned = prune_tree(t, [25165823])
